      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-sm">
            <li><Link to="/" className="hover:text-[#B8834E] transition-colors">Home</Link></li>
            <li><Link to="/about" className="hover:text-[#B8834E] transition-colors">About Us</Link></li>
            <li><Link to="/products" className="hover:text-[#B8834E] transition-colors">Products</Link></li>
            <li><Link to="/blogs" className="hover:text-[#B8834E] transition-colors">Blogs</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-sm">
            <li><a href="#" className="hover:text-[#B8834E] transition-colors">Shipping Policy</a></li>
            <li><a href="#" className="hover:text-[#B8834E] transition-colors">Brew Guides</a></li>
            <li><a href="#" className="hover:text-[#B8834E] transition-colors">Contact Us</a></li>
            <li><a href="#" className="hover:text-[#B8834E] transition-colors">Wholesale</a></li>
          </ul>
        </div>
